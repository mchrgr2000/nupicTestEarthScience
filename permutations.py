...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          u'acc': PermuteEncoder(maxval=15.0, fieldName='acc', w=21, clipInput=True, minval=-15.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=acc")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=acc"
